  ...
  return (
    <div className="p-8 bg-primary">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 lg:grid-rows-3 place-items-stretch gap-4 p-8 ">
        ...
        <div className="lg:col-span-2 lg:col-start-3 row-start-1">
          <p>
            We are fastest growing real estate company with an utmost believer
            of fast expansion mode strategy with greater sustainability and
            profitability. Providing unavailable solution to each entity belongs
            to real estate is our only mission.
          </p>
        </div>
        <div className="lg:col-start-5 lg:row-start-1">
          <img className="w-full h-full" src={image2} />
        </div>
        <div className="lg:col-span-3 lg:col-start-3 row-start-2">
          <img className="w-full h-full" src={image3} />
        </div>
        <div className="lg:col-span-5 lg:col-start-1 row-start-3">
